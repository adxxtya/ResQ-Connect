        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
                    ...
                    <React.Fragment>
                        ...
                        >
                          ...
                          <g id="SVGRepo_iconCarrier">
                            ...
                            <g>
                              ...
                              <g>
                                {" "}
                                <path d="M112.387,34.959c5.544,5.66,10.226,11.869,13.926,18.376c8.595-5.006,18.726-8.378,30.015-9.17 c-15.226,11.615-3.534,60.52-25.948,75.203l-0.407,0.65c48.627,0.856,37.054-77.567,57.239-95.069 C156.712,11.304,129.753,18.811,112.387,34.959z"></path>{" "}
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/resources/add-resources"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                (pathname === "/resources/add-resources" ||
                                  pathname ===
                                    "/resources/add-resources/new") &&
                                "text-white"
                              } `}
                            >
                              Update Resources
                          ...
                          {/* <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/resources/our-resources" &&
                                "text-white"
                              } `}
                            >
                              Our Agency
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/resources/others-resources" &&
                                "text-white"
                              } `}
                            >
                              Other Agencies
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/connect" || pathname.includes("connect")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/connect/all-agencies"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/connect/all-agencies" &&
                                "text-white"
                              } `}
                            >
                              With All Agencies
                          ...
                          <li>
                            <Link
                              href="/connect/specific-agency"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/connect/specific-agency" &&
                                "text-white"
                              } `}
                            >
              ...
              {/* <li>
                <Link
                  href="/auth"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("auth") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
